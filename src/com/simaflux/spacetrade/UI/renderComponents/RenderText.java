 ...
 *
 */
public class RenderText extends RenderComponent {
	 ...
	 */
	public RenderText(UIComponent component, String text, float fontSize, FontType font, float maxLineLength, boolean centered) {
		super(component);
		this.textString = text;
		this.fontSize = fontSize / Vars.HEIGHT * 60;
		this.font = font;
